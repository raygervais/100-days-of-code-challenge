...
class Dog:
    ...
    def _remove_old_trick_comparitor(self, trick, comparitor):
...
if your_dog.is_good_boy:
    print(your_dog.name + ' is a good boy / girl!')

print('We don\'t know what tricks they can do!')

your_dog_tricks = input('Please enter the tricks your dog can do here, \
